...
$(function () {
 ...
 <!--Body-->
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="images/banner/watchBanner.jpg" alt="New products" >
			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="images/products/watch/watch.jpg.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="images/products/watch/watch.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="images/products/watch/watch.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="images/products/watch/watch.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="images/products/watch/watch.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="images/products/watch/watch.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="images/products/watch/watch.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="images/products/watch/watch.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="images/products/watch/watch.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="images/products/watch/watch.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">
								<address>
									...
									<strong>Product Code:</strong> <span>iWatch</span><br>
							...
							<div class="span5">
								<form class="form-inline">
									...
									<label>Qty:</label>
									<input type="text" class="span1" placeholder="1"><i> </i>	
