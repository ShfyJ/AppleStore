			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="images/products/ipad/ipad_3.png" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="images/products/ipad/ipad_3.png"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="images/products/ipad/ipad_3.png" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="images/products/ipad/ipad_3.png" alt=""></a>
									</li>								
									<li class="span1">
										<a href="images/products/ipad/ipad_3.png" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="images/products/ipad/ipad_3.png" alt=""></a>
									</li>													
									<li class="span1">
										<a href="images/products/ipad/ipad_3.png" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="images/products/ipad/ipad_3.png" alt=""></a>
									</li>
									<li class="span1">
										<a href="images/products/ipad/ipad_3.png" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="images/products/ipad/ipad_3.png" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">
								<address>
									...
									<strong>Product Code:</strong> <span>iPad 3</span><br>
								\
