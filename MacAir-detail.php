			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="images/products/mac/3-air.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="images/products/mac/3-air.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="images/products/mac/3-air.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="images/products/mac/3-air.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="images/products/mac/3-air.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="images/products/mac/3-air.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="images/products/mac/3-air.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="images/products/mac/3-air.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="images/products/mac/3-air.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="images/products/mac/3-air.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">
								<address>
									...
									<strong>Product Code:</strong> <span>macBook Air</span><br>
									
									<strong>Availability:</strong> <span>Availabile</span><br>								
								</address>									
								<h4><strong>Price: $1199</strong></h4>
							</div>
							<div class="span5">
