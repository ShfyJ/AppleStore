			...
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="images/products/mac/2-15.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="images/products/mac/2-15.jpg"></a>												
								<ul class="thumbnails small">								
									<li class="span1">
										<a href="images/products/mac/2-15.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 2"><img src="images/products/mac/2-15.jpg" alt=""></a>
									</li>								
									<li class="span1">
										<a href="images/products/mac/2-15.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 3"><img src="images/products/mac/2-15.jpg" alt=""></a>
									</li>													
									<li class="span1">
										<a href="images/products/mac/2-15.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 4"><img src="images/products/mac/2-15.jpg" alt=""></a>
									</li>
									<li class="span1">
										<a href="images/products/mac/2-15.jpg" class="thumbnail" data-fancybox-group="group1" title="Description 5"><img src="images/products/mac/2-15.jpg" alt=""></a>
									</li>
								</ul>
							</div>
							<div class="span5">
								<address>
									...
									<strong>Product Code:</strong> <span>macBook Pro 15</span><br>
								
									<strong>Availability:</strong> <span>Availabile</span><br>								
								</address>									
								<h4><strong>Price: $2799</strong></h4>
							</div>
							<div class="span5">
